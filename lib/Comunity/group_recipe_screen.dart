...
class GroupRecipeScreen extends StatefulWidget {
  final Recipe recipe;
  final Group group;
  final bool isEnglish;

  const GroupRecipeScreen({
    super.key,
  ...
  @override
  State<GroupRecipeScreen> createState() => _GroupRecipeScreenState();
}

class _GroupRecipeScreenState extends State<GroupRecipeScreen> {
  ...
  @override
  void didUpdateWidget(GroupRecipeScreen oldWidget) {
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  ...
                  child: Text(isEnglish ? 'Edit ingredients' : 'Editar ingredientes'),
                ),
              ],
            ),
              ...
              itemBuilder: (context, index) {
                if (index == _steps.length) {
                  return TextButton(
                    ...
                    child: Text(isEnglish ? 'Add step' : 'Agregar paso'),
                  );
                }
                return Card(
