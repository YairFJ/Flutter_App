...
class _ConversionCalculatorScreenState
  ...
  double _rendimientoNuevo = 1.0;
  String _unidadNueva = 'Persona';
  String _nombreReceta = '';
  double _rendimientoOriginal = 1.0;
  List<IngredienteTabla> _ingredientes = [];
            ...
            child: ElevatedButton(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    _getTextoTraducido('Generar PDF', 'Share PDF'),
  ...
  String _getTextoTraducido(String espanol, String ingles) {
    return isEnglish ? ingles : espanol;
  }

  String _formatNumber(double number) {
    return number == number.round() ? number.round().toString() : number.toString();
  }
  ...
  Future<void> _generarPDF() async {
    try {
              ...
              child: pw.Column(
                ...
                children: [
                  ...
                  pw.Row(
                    children: [
                      pw.Text(
                        'Rendimiento: ${_formatNumber(_platosDestino)} $_unidadDestino',
                        style: pw.TextStyle(
                          fontSize: 14,
                          color: primaryColor,
                          fontWeight: pw.FontWeight.bold,
                  ...
                  pw.Table(
                    ...
                    children: [
                      ...
                      ..._ingredientesTabla.map((ing) => pw.TableRow(
                        children: [
                          pw.Padding(
                            padding: const pw.EdgeInsets.all(8.0),
                            child: pw.Text(
                          ...
                          pw.Padding(
                            padding: const pw.EdgeInsets.all(8.0),
                            child: pw.Text(
                              '${_formatNumber(ing.cantidad)} ${ing.unidad}',
                              textAlign: pw.TextAlign.center,
                              style: pw.TextStyle(
                                fontWeight: pw.FontWeight.bold,
                              ),
      ...
      final file = File('${output.path}/conversion_details.pdf');
      await file.writeAsBytes(await pdf.save());

      // Compartir el PDF
      await Share.shareXFiles(
        [XFile(file.path)],
        text: isEnglish ? 'Conversion Details' : 'Detalles de Conversión',
      );
